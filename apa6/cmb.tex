...
read/write ratios. The results are beased on a rigorous benchmark methodology
that took into consideration 33 parameters that can affect the performance of
such a system. These findings are useful for developers of storage systems and
web applications about the viability of a consistency model other than eventual
