...
\abstract{Large-scale web systems leverage data replication to achieve high levels
...
more restrictive. However, little is known about its performance compared to
eventual consistency.

In this paper, we show that these consistency models have similar performance
in a system under certain workloads and network conditions, such as high data
locality and high read/write ratios. When such conditions are not met, eventual
consistency shows better performance. The results are based on a rigorous
methodology that took into consideration 33 parameters that can affect the
performance of such systems. These findings are useful for practitioners and
researchers to understand the viability of a consistency model other
...
\includegraphics[width=1.0\textwidth]{beanplot_get.pdf}
...
\includegraphics[width=1.0\textwidth]{beanplot_upd.pdf}
