...
were fixed due to resource constraints. It is worth noting that LAN parameters
were the actual values seeing in the cluster network, while WAN parameters were
emulated. The fixed parameters and their respective values were:
