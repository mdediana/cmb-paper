...
This study compared the performance of a storage system operating over a WAN
using two different consistency models. It also showed results about the
influence of different factors and their interactions on the system
performance. The results show that per-object timeline consistency is
competitive to eventual consistency when write locality is high and when stale
reads are an option.
